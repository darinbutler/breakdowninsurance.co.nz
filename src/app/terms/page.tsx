...
export default function TermsPage() {
  return (
    <>
      <div className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{ backgroundImage: 'url(/hero-2.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
